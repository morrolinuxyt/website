<?php include "assets/head.html"; ?>
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="lpi.php"><div class="banner"><img src="img/right-arrow.svg" class="blink arrow"/> Novità! Tutti i corsi Linux in <b>offerta speciale</b> a € 9,99 - Clicca qui <img src="img/left-arrow.svg" class="blink arrow"/></div></a>
